package com.cogworksstudios.thriveorsurvive.game;
 ...
 *
 */
public class ThriveOrSurvive extends SimpleApplication {

    public ThriveOrSurvive() {
    }

    public ThriveOrSurvive(AppState... initialStates) {
        super(initialStates);
    }
